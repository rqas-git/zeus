            ...
            VStack(spacing: 0) {
                ...
                FooterBar(
                    ...
                    model: FooterMenuConfig(
                        ...
                        highlightedOption: modelMenuHighlightedOption,
                        optionTitle: viewModel.displayModel,
                        help: "Model",
                        onSelect: viewModel.selectModel,
                        onHighlight: { modelMenuHighlightedOption = $0 }
                    ),
                    effort: FooterMenuConfig(
                        id: .effort,
                        title: viewModel.effort,
                        options: viewModel.effortOptions,
                        selectedOption: viewModel.effort,
                        isEnabled: viewModel.canChangeEffort,
                        highlightedOption: effortMenuHighlightedOption,
                        help: "Reasoning Effort",
                        onSelect: viewModel.selectEffort,
                        onHighlight: { effortMenuHighlightedOption = $0 }
                    ),
                    permissions: FooterMenuConfig(
                        id: .permissions,
                        title: viewModel.permissions,
                        options: viewModel.permissionOptions,
                        selectedOption: viewModel.selectedPermission,
                        isEnabled: viewModel.canChangePermissions,
                        highlightedOption: permissionsMenuHighlightedOption,
                        optionTitle: viewModel.displayPermission,
                        help: "Permissions",
                        onSelect: viewModel.selectPermissions,
                        onHighlight: { permissionsMenuHighlightedOption = $0 }
                    ),
