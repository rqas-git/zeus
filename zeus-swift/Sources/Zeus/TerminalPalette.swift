...
enum TerminalPalette {
    static let background = Color(red: 0.107, green: 0.104, blue: 0.118)
    static let backgroundLow = Color(red: 0.076, green: 0.074, blue: 0.086)
    static let codeBackground = Color(red: 0.132, green: 0.128, blue: 0.144)
    static let primaryText = Color(red: 0.928, green: 0.926, blue: 0.940)
